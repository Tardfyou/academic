...
`studio/lens.js` adapts the `compute1D` refraction calculation and
...
- Full license: [`studio/licenses/devsam-liquid-glass-MIT.txt`](studio/licenses/devsam-liquid-glass-MIT.txt)
